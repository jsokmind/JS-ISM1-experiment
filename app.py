...
if (
    ...
    with col3:
        if st.session_state.awaiting_feedback and st.session_state.last_outcome:
            ...
            st.markdown(f"<div style='font-size: 14px; color: #666; margin-bottom: 4px;'>Balance</div><div style='font-size: 28px; font-weight: 700;'>${st.session_state.balance} {animation}</div>", unsafe_allow_html=True)
        else:
...
if (
    ...
    with col3:
        if st.session_state.awaiting_feedback and st.session_state.last_outcome:
            ...
            st.markdown(f"<div style='font-size: 14px; color: #665; margin-bottom: 4px;'>Balance</div><div style='font-size: 28px; font-weight: 700;'>${st.session_state.balance} {animation}</div>", unsafe_allow_html=True)
        else:
            st.metric("Balance", st.session_state.balance)
